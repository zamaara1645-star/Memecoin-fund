...
declare const VERSION_1_MESSAGE_PREFIX = 129;
/**
 * The maximum size of a version 1 transaction in bytes.
 */
declare const V1_TRANSACTION_SIZE_LIMIT = 4096;
...
type VersionedMessage = Message | MessageV0 | MessageV1;
